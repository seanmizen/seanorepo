...
import {
  to = cloudflare_zone.friendsgay_app
  id = "988ec1184f89fc7fba80322beafb47dc"
}

import {
  to = cloudflare_dns_record.friendsgay_app_apex_cname
  id = "988ec1184f89fc7fba80322beafb47dc/c3f659f32473d4a4bdc300692cc4eca2"
}

import {
  to = cloudflare_dns_record.friendsgay_app_www_cname
  id = "988ec1184f89fc7fba80322beafb47dc/75af3b27a4ac7397c131c4b562273030"
}

import {
  to = cloudflare_zone.friendsgay_com
  id = "ce958f170485dcb81cdac65027d176fd"
}

import {
  to = cloudflare_dns_record.friendsgay_com_apex_cname
  id = "ce958f170485dcb81cdac65027d176fd/5deaac44351177ecb247b8a774e3f8b1"
}

import {
  to = cloudflare_dns_record.friendsgay_com_www_cname
  id = "ce958f170485dcb81cdac65027d176fd/c0075b9d6fa37e75d83bfa93cdd29d25"
}
