...
function runSketch() {
  ...
  function getSimulator(simSizeX, simSizeY, renderer) {
    ...
    gpuSimulator.setVariableDependencies(positionVariable, [
      positionVariable,
      velocityVariable,
    ]);
    gpuSimulator.setVariableDependencies(velocityVariable, [
      positionVariable,
      velocityVariable,
    ]);
  ...
  function render() {
    ...
    positionVariable.material.uniforms.u_nActiveParticles.value =
      nActiveParticles;
    velocityVariable.material.uniforms.u_nActiveParticles.value =
      nActiveParticles;
    uniforms.u_nActiveParticles.value = nActiveParticles;
    uniforms.u_positionTexture.value =
      simulator.getCurrentRenderTarget(positionVariable).texture;
    frames++;
