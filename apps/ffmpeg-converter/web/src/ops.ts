...
export const flagshipPresets: Preset[] = [
  {
    ...
    tag: '.mp4 → .webm',
    description:
      'Re-encode a video to WebM (VP9 + Opus). Smaller, web-friendly.',
    category: 'video',
    outputExt: '.webm',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: '.mov → .mp4',
    description:
      'iPhone → everywhere. Re-encodes to H.264 + AAC inside an MP4 container.',
    category: 'video',
    outputExt: '.mp4',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: 'video → .gif',
    description:
      'Animated GIF from a video. 10 fps, 96 px wide, palettegen for quality.',
    category: 'image',
    outputExt: '.gif',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    label: 'Video → MP3',
    tag: '* → .mp3',
    description: 'Strip or convert audio to MP3 at 64 kbps by default.',
    category: 'audio',
    outputExt: '.mp3',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: 'target 10 MB',
    description:
      'Re-encode video at a target bitrate to fit Discord/Bluesky upload caps.',
    category: 'video',
    outputExt: '.mp4',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: '1 frame → .jpg',
    description: 'Extract a single frame at a timestamp as a JPG.',
    category: 'image',
    outputExt: '.jpg',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    description: 'Trim a video by start + duration (seconds).',
    category: 'video',
    outputExt: '.mp4',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: 'w × h',
    description:
      'Scale a video to a target width and height. Uses -1 to auto-preserve aspect.',
    category: 'video',
    outputExt: '.mp4',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: '.png/.jpg → .webp',
    description:
      'Convert an image to WebP. Smaller than PNG, wider support than AVIF.',
    category: 'image',
    outputExt: '.webp',
    minInputs: 1,
  ...
  },
  {
    ...
    label: 'HEIC/PNG → JPG',
    tag: '* → .jpg',
    description: 'Normalise an image to JPEG for universal compatibility.',
    category: 'image',
    outputExt: '.jpg',
    minInputs: 1,
  ...
  },
  {
    ...
    tag: 'EBU R128',
    description:
      'Loudness-normalise audio to -16 LUFS, -1.5 dBTP, LRA=11 (podcast-friendly).',
    category: 'audio',
    outputExt: '.wav',
    minInputs: 1,
    presets: [
  ...
  },
  {
    ...
    tag: 'N × M grid',
    description:
      'Grid of frames sampled across a video — great for a blog post or a memory.',
    category: 'image',
    outputExt: '.jpg',
    minInputs: 1,
    presets: [
