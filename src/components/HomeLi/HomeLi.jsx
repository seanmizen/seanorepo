...
function HomeLi({ children, trigger, subLink, setIsSnowing }) {
  ...
  const toggleCollapsible = e => {
    ...
    const collapsibleRef = Array.from(e.currentTarget.parentNode.children).filter(
  ...
  return (
    <li onFocus={onFocus} onBlur={onBlur} onMouseOver={onMouseOver} onMouseOut={onMouseOut}>
